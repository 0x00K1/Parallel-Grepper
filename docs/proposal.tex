...
parallel-grepper/
    ...
    benchmarks/
        run_sequential_benchmarks.py  # Sequential benchmarks
        run_parallel_benchmarks.py    # Parallel benchmarks
        analyze_sequential_results.py # Visualization & analysis
        analyze_parallel_results.py   # Visualization & analysis
...
\begin{itemize}[itemsep=2pt]
    \item Fourth Year, Semester 1, Academic Year 2024-2025
